...
_0x3:
	.DB  0x49,0x52,0x41,0x4E
_0x0:
	.DB  0x31,0x33,0x39,0x37,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0085 // RS - PORTB Bit 0
; 0000 0086 // RD - PORTB Bit 1
; 0000 0087 // EN - PORTB Bit 2
; 0000 0088 // D4 - PORTB Bit 4
; 0000 0089 // D5 - PORTB Bit 5
; 0000 008A // D6 - PORTB Bit 6
; 0000 008B // D7 - PORTB Bit 7
...
; 0000 0095       lcd_puts(s);
	...
	LDI  R27,HIGH(_s)
	RCALL _lcd_puts
; 0000 0096       lcd_gotoxy(6,1);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 0097       lcd_putsf("1397");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
