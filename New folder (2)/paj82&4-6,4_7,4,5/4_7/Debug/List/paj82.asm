...
; 0000 0084 // RS - PORTB Bit 0
; 0000 0085 // RD - PORTB Bit 1
; 0000 0086 // EN - PORTB Bit 2
; 0000 0087 // D4 - PORTB Bit 4
; 0000 0088 // D5 - PORTB Bit 5
; 0000 0089 // D6 - PORTB Bit 6
; 0000 008A // D7 - PORTB Bit 7
; 0000 008B // Characters/line: 8
...
; 0000 0092       lcd_clear();
	RCALL _lcd_clear
; 0000 0093       lcd_gotoxy(x,0);
	ST   -Y,R5
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0094       lcd_putsf("IRAN");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
