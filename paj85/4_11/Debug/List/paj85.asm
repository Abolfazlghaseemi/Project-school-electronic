...
_0x0:
	.DB  0x50,0x72,0x65,0x73,0x73,0x20,0x6B,0x65
	.DB  0x79,0x3A,0x0,0x25,0x30,0x32,0x64,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0034 DDRC=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (0<<DDD3) | (0<<DDD2) | (0<<DDD1) | (0<<DDD0);
	OUT  0x14,R30
...
_0xF:
	RJMP _0xE
_0x10:
; 0000 0091       delay_ms(25);
	LDI  R26,LOW(25)
	RCALL SUBOPT_0x0
; 0000 0092       i++;
	INC  R5
; 0000 0093       sprintf(s,"%02d",i);
	RCALL SUBOPT_0x1
; 0000 0094       lcd_gotoxy(10,0);
; 0000 0095       lcd_puts(s);
; 0000 0096       delay_ms(200);
; 0000 0097 
; 0000 0098       }
; 0000 0099       if(PINB.1==0&&i>0){
_0xE:
	SBIC 0x16,1
	RJMP _0x12
	LDI  R30,LOW(0)
...
; 0000 009B       i--;
	DEC  R5
; 0000 009C       sprintf(s,"%02d",i);
	RCALL SUBOPT_0x1
; 0000 009D       lcd_gotoxy(10,0);
