...
; 0000 0083 // RS - PORTD Bit 0
; 0000 0084 // RD - PORTD Bit 1
; 0000 0085 // EN - PORTD Bit 2
; 0000 0086 // D4 - PORTD Bit 4
; 0000 0087 // D5 - PORTD Bit 5
; 0000 0088 // D6 - PORTD Bit 6
; 0000 0089 // D7 - PORTD Bit 7
; 0000 008A // Characters/line: 8
...
; 0000 0091       lcd_clear();
	RCALL _lcd_clear
; 0000 0092       lcd_gotoxy(x,0);
	ST   -Y,R5
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0093       lcd_putsf("IRAN");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
