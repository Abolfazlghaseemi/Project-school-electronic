...
_0x0:
	.DB  0x4C,0x49,0x47,0x48,0x54,0x3A,0x25,0x30
	.DB  0x34,0x64,0x0,0x4C,0x41,0x4D,0x50,0x20
	.DB  0x4F,0x46,0x46,0x0,0x4C,0x41,0x4D,0x50
...
; 0000 0089 // ADC Clock frequency: 250/000 kHz
; 0000 008A // ADC Voltage Reference: AVCC pin
; 0000 008B ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 008C ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (0<<ADPS0);
	LDI  R30,LOW(130)
	OUT  0x6,R30
...
; 0000 00A7       a=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R4,R30
; 0000 00A8       sprintf(s,"LIGHT:%04d",a);
	LDI  R30,LOW(_s)
	LDI  R31,HIGH(_s)
	RCALL SUBOPT_0x0
	__POINTW1FN _0x0,0
