...
_0x0:
	.DB  0x56,0x3D,0x25,0x30,0x32,0x2E,0x34,0x46
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 004D TCCR0=(0<<CS02) | (0<<CS01) | (0<<CS00);
	OUT  0x33,R30
...
; 0000 0072 TIMSK=(0<<OCIE2) | (0<<TOIE2) | (0<<TICIE1) | (0<<OCIE1A) | (0<<OCIE1B) | (0<<TOIE1) | (0<<TOIE0);
	OUT  0x39,R30
; 0000 0073 
...
; 0000 0086 // ADC Clock frequency: 125/000 kHz
; 0000 0087 // ADC Voltage Reference: AREF pin
; 0000 0088 ADMUX=ADC_VREF_TYPE;
	LDI  R30,LOW(0)
	OUT  0x7,R30
; 0000 0089 ADCSRA=(1<<ADEN) | (0<<ADSC) | (0<<ADFR) | (0<<ADIF) | (0<<ADIE) | (0<<ADPS2) | (1<<ADPS1) | (1<<ADPS0);
	LDI  R30,LOW(131)
	OUT  0x6,R30
...
_0x6:
; 0000 00A2       {
; 0000 00A3         a=read_adc(0);
	LDI  R26,LOW(0)
	RCALL _read_adc
	MOVW R16,R30
; 0000 00A4       b=a*.00488758;
	RCALL __CWD1
	RCALL __CDF1
	__GETD2N 0x3BA027FE
	RCALL __MULF12
	__PUTD1S 16
; 0000 00A5       sprintf(s,"V=%02.4F",b);
	MOVW R30,R28
	RCALL SUBOPT_0x0
	__POINTW1FN _0x0,0
	RCALL SUBOPT_0x0
...
; 0000 00A6       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 00A7       lcd_puts(s);
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 00A8       lcd_gotoxy(0,8);
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(8)
	RCALL _lcd_gotoxy
; 0000 00A9       lcd_putchar('v');
	LDI  R26,LOW(118)
	RCALL _lcd_putchar
; 0000 00AA 
; 0000 00AB 
