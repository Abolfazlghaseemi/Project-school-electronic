...
_0x0:
	.DB  0x41,0x52,0x41,0x53,0x48,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0081 // RS - PORTB Bit 0
; 0000 0082 // RD - PORTB Bit 1
; 0000 0083 // EN - PORTB Bit 2
; 0000 0084 // D4 - PORTB Bit 4
; 0000 0085 // D5 - PORTB Bit 5
; 0000 0086 // D6 - PORTB Bit 6
; 0000 0087 // D7 - PORTB Bit 7
...
; 0000 008E       lcd_gotoxy(6,1);
	LDI  R30,LOW(6)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _lcd_gotoxy
; 0000 008F       lcd_putsf("ARASH");
	__POINTW2FN _0x0,0
	RCALL _lcd_putsf
; 0000 0090 
; 0000 0091       }
